...
map('n', '<Space>sb', '<Cmd>BufferOrderByBufferNumber<CR>', opts)
map('n', '<Space>sd', '<Cmd>BufferOrderByDirectory<CR>', opts)
map('n', '<Space>sl', '<Cmd>BufferOrderByLanguage<CR>', opts)
map('n', '<Space>sw', '<Cmd>BufferOrderByWindowNumber<CR>', opts)
